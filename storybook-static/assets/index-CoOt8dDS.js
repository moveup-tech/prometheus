...
import { c as g } from "./index-DW2zCSF8.js";
...
const l = g({
  ...
  variants: {
    ...
    disabled: { true: "bg-zinc-600 hover:bg-zinc-700 cursor-not-allowed" },
  },
...
function p({
  ...
  const y = d || "button",
    r = u,
    a = f;
  return m && c.isValidElement(e)
    ? c.cloneElement(e, {
        ...i,
        className: l({ className: s, variant: n, disabled: o }),
      })
    : t.jsxs(y, {
        ...i,
        className: l({ className: s, variant: n, disabled: o }),
        children: [r && t.jsx(r, {}), e, a && t.jsx(a, {})],
      });
}
...
p.__docgenInfo = {
  ...
  displayName: "Button",
  props: {
    as: { required: !1, tsType: { name: "ElementType" }, description: "" },
