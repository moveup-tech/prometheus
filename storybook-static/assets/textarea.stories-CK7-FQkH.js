...
import { c as f } from "./index-DW2zCSF8.js";
import { r as g } from "./index-BuYn5Wpo.js";
...
const b = f({
  ...
  t = g.forwardRef(({ error: r, name: m, className: p, ...u }, x) =>
    e.jsxs(e.Fragment, {
      children: [
        e.jsx("div", {
          className: b({ className: p }),
        ...
        r &&
          e.jsx("p", { className: "mt-1 text-xs text-red-600", children: r }),
      ],
    })
  );
