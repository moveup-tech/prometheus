    ...
    children: [
      ...
      Icon4 &&
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Icon4, {
            size: 16,
          }),
        }),
    ],
          ...
          onClick &&
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                import_lucide_react.ArrowDownUp,
                { size: 12 }
              ),
            }),
        ],
...
var Dialog = {
  ...
  Header: ({ children, className }) =>
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(DialogPrimitive.Close, {
          asChild: true,
...
var Input = (0, import_react.forwardRef)((_a, ref) => {
  var _b = _a,
...
var Item2 = (0, import_react2.forwardRef)((_a, ref) => {
  var _b = _a,
    { children } = _b,
    rest = __objRest(_b, ["children"]);
      ...
      ),
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
            SelectPrimitive2.ItemText,
            { children }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
            SelectPrimitive2.ItemIndicator,
            {
              children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
                import_lucide_react4.CheckIcon,
                { size: 14, className: "text-primary-dark" }
              ),
            }
          ),
        ],
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(
    ...
    __spreadProps(__spreadValues({}, rest), {
      ...
      children: [
        children,
        error &&
          /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("small", {
            className: "mt-1 text-xs text-rose-600",
            children: error,
          }),
      ],
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime31.jsxs)(
    ...
    __spreadProps(__spreadValues({}, rest), {
      ...
      children: [
        ...
        children,
        IconRight &&
          /* @__PURE__ */ (0, import_jsx_runtime31.jsx)(IconRight, {}),
      ],
    })
  );
}
...
function Checkbox({ checked = false, disabled = false, onValueChange }) {
  const [isChecked, setIsChecked] = (0, import_react4.useState)(checked);
  const toggleCheck = () => {
...
var TextArea = (0, import_react5.forwardRef)((_a, ref) => {
  var _b = _a,
    { error, name, className } = _b,
    rest = __objRest(_b, ["error", "name", "className"]);
  return /* @__PURE__ */ (0, import_jsx_runtime33.jsxs)(
    import_jsx_runtime33.Fragment,
    {
      children: [
...
var InputFile = (0, import_react6.forwardRef)((_a, ref) => {
  var _b = _a,
    { accept = ".pdf" } = _b,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)("div", {
    ...
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("label", {
        htmlFor: "file",
        className:
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("div", {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("small", {
            children: !files
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("div", {
                      ...
                      children: /* @__PURE__ */ (0, import_jsx_runtime34.jsx)(
                        import_lucide_react6.UploadIcon,
                        { className: "text-zinc-400" }
                      ),
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)("small", {
                      className: "text-zinc-500",
              ...
              : /* @__PURE__ */ (0, import_jsx_runtime34.jsxs)("div", {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime34.jsx)("small", {
                      className: "text-zinc-500",
                    }),
                  ],
                }),
...
function DatePicker({ defaultValue, onValueChange, mode = "single" }) {
    ...
    return {
      ...
      to:
        defaultValue && defaultValue.to
          ? defaultValue.to
          : (0, import_date_fns.add)(/* @__PURE__ */ new Date(), {
              days: 15,
            }),
    };
  });
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)(Popover.Root, {
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(Popover.Trigger, {
        children: /* @__PURE__ */ (0, import_jsx_runtime36.jsxs)(Button, {
          variant: "ghost",
          className: "w-full border border-zinc-300",
          type: "button",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(
              import_lucide_react7.Calendar1,
              { size: 14 }
            ),
            mode === "single"
              ? (0, import_date_fns.format)(selected, "dd/LL/yyyy")
              : (0, import_date_fns.format)(
                  selected.from || /* @__PURE__ */ new Date(),
                  "dd/LL/yyyy"
                ) +
                " - " +
                (0, import_date_fns.format)(
                  selected.to || /* @__PURE__ */ new Date(),
                  "dd/LL/yyyy"
                ),
          ],
        }),
      }),
      /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(Popover.Portal, {
        children: /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(
          Popover.Content,
          {
            align: "start",
            children: /* @__PURE__ */ (0, import_jsx_runtime36.jsx)(Calendar, {
              required: true,
              className: "mt-2",
              mode,
              selected,
...
var YearPicker = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)(Popover9.Root, {
    children: [
      /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(Popover9.Trigger, {
        children: /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)(Button, {
          variant: "ghost",
          className: "w-full border border-zinc-300",
          type: "button",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(
              import_lucide_react8.Calendar1,
              { size: 14 }
            ),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(Popover9.Portal, {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime44.jsxs)("div", {
                  ...
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("button", {
                      ...
                      children: /* @__PURE__ */ (0, import_jsx_runtime44.jsx)(
                        import_lucide_react8.ChevronLeft,
                        {}
                      ),
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime44.jsx)("button", {
  ...
  (_a, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime52.jsxs)(
      ...
      __spreadProps(__spreadValues({}, rest), {
        ...
        children: [
          Icon4 &&
            /* @__PURE__ */ (0, import_jsx_runtime52.jsx)(Icon4, { size: 14 }),
          children,
        ],
      })
    );
...
function SidebarProvider({ children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime56.jsx)(SidebarContext.Provider, { value, children });
}
...
var textVariant = (0, import_tailwind_variants20.tv)({
  variants: {
    size: {
      xs: "text-xs",
      sm: "text-sm",
...
function Root12(_a) {
  var _b = _a, { children } = _b, rest = __objRest(_b, ["children"]);
  return /* @__PURE__ */ (0, import_jsx_runtime60.jsx)(SidebarProvider, __spreadProps(__spreadValues({}, rest), { children }));
}
...
function Heading(_a) {
  ...
  const As = as;
  return /* @__PURE__ */ (0, import_jsx_runtime61.jsx)(As, __spreadProps(__spreadValues({ className: headingVariant({ size, className }) }, rest), { children }));
}
...
function Footer3(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime63.jsxs)(
    ...
    __spreadProps(__spreadValues({}, rest), {
      ...
      children: [
        children,
        /* @__PURE__ */ (0, import_jsx_runtime63.jsxs)("div", { className: "flex items-center gap-2 rounded-b border-t border-t-zinc-200 bg-zinc-50 p-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime63.jsx)(Avatar, { image: user.image, username: user.name }),
          /* @__PURE__ */ (0, import_jsx_runtime63.jsxs)(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime63.jsx)(Text, { size: "lg", as: "strong", children: user.name }),
                /* @__PURE__ */ (0, import_jsx_runtime63.jsx)(Text, { size: "xs", as: "small", className: "-mt-1 text-zinc-400", children: user.role })
              ]
            }
          )
        ] })
...
function List2(_a) {
  var _b = _a, { children } = _b, rest = __objRest(_b, ["children"]);
  return /* @__PURE__ */ (0, import_jsx_runtime68.jsx)(Navigation2.List, { id: "navigation", children });
}
...
function Root14(_a) {
  var _b = _a, { children } = _b, rest = __objRest(_b, ["children"]);
  return /* @__PURE__ */ (0, import_jsx_runtime69.jsx)(Navigation3.Root, { id: "navigation", children });
}
...
function Link2(_a) {
  var _b = _a, { children } = _b, rest = __objRest(_b, ["children"]);
  return /* @__PURE__ */ (0, import_jsx_runtime70.jsx)(Navigation4.Link, __spreadProps(__spreadValues({}, rest), { children }));
}
